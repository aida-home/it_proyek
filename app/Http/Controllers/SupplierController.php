...
class SupplierController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('suppliers', compact('suppliers')); // Menampilkan view 'supplier' dengan data supplier
    }

    // Method untuk menampilkan form tambah supplier
    public function create()
    {
        return view('suppliers'); // Ganti dengan view yang sesuai jika diperlukan
    }
    ...
    public function store(Request $request)
    {
        ...
        $newId = 'SP' . str_pad($newIdNumber, 2, '0', STR_PAD_LEFT);
    ...
    public function edit($id)
    {
        ...
        return view('edit-supplier', compact('suppliers')); // Menampilkan form edit supplier
    }
