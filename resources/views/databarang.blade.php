...
<body>
    <div class="container">
        ...
        <div class="box">
            ...
            <a href="{{ route('databarang.create') }}" class="btn">Tambah Barang</a>
            <table>
                <thead>
                    <tr>
                        <th>ID Barang</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('databarang.edit', $barang->id_databarang) }}" class="btn-edit">Edit</a>
                                <form action="{{ route('databarang.destroy', $barang->id_databarang) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
